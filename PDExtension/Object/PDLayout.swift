...
public func equal(centerX target: Any?,_ value: CGFloat) -> PDLayout { return PDLayout(.xEqual, target, value) };
public func equal(centerY target: Any?,_ value: CGFloat) -> PDLayout { return PDLayout(.yEqual, target, value) };
public func equal(top target: Any?,_ value: CGFloat) -> PDLayout { return PDLayout(.tEqual, target, value) };
public func equal(left target: Any?,_ value: CGFloat) -> PDLayout { return PDLayout(.lEqual, target, value) };
public func equal(bottom target: Any?,_ value: CGFloat) -> PDLayout { return PDLayout(.bEqual, target, value) };
public func equal(right target: Any?,_ value: CGFloat) -> PDLayout { return PDLayout(.rEqual, target, value) };
public func equal(width target: Any?,_ value: CGFloat) -> PDLayout { return PDLayout(.wEqual, target, value) };
public func equal(height target: Any?,_ value: CGFloat) -> PDLayout { return PDLayout(.hEqual, target, value) };

public func greater(top target: Any?,_ value: CGFloat) -> PDLayout { return PDLayout(.tGreater, target, value) };
public func greater(left target: Any?,_ value: CGFloat) -> PDLayout { return PDLayout(.lGreater, target, value) };
public func greater(bottom target: Any?,_ value: CGFloat) -> PDLayout { return PDLayout(.bGreater, target, value) };
public func greater(right target: Any?,_ value: CGFloat) -> PDLayout { return PDLayout(.rGreater, target, value) };
public func greater(width target: Any?,_ value: CGFloat) -> PDLayout { return PDLayout(.wGreater, target, value) };
public func greater(height target: Any?,_ value: CGFloat) -> PDLayout { return PDLayout(.hGreater, target, value) };

public func less(top target: Any?,_ value: CGFloat) -> PDLayout { return PDLayout(.tLess, target, value) };
public func less(left target: Any?,_ value: CGFloat) -> PDLayout { return PDLayout(.lLess, target, value) };
public func less(bottom target: Any?,_ value: CGFloat) -> PDLayout { return PDLayout(.bLess, target, value) };
public func less(right target: Any?,_ value: CGFloat) -> PDLayout { return PDLayout(.rLess, target, value) };
public func less(width target: Any?,_ value: CGFloat) -> PDLayout { return PDLayout(.wLess, target, value) };
public func less(height target: Any?,_ value: CGFloat) -> PDLayout { return PDLayout(.hLess, target, value) };
